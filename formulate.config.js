     ...
     // console.log(context)
      ...
      switch (context.classification) {
        ...
        case "box":
            return "w-auto bg-retro-mediumpurple hover:bg-retro-black text-white font-bold py-2 px-4 border-b-4 border-retro-Deeppurple hover:border-black rounded";
        case "text":
              return "border border-retro-aqua w-auto bg rounded px-2 py-2 mx-1 mb-1 leading-none focus:border-green-500 outline-none border-box  text-black flex.auto ease-linear transform hover:scale-105 transition duration-500 bg-retro-blue ";
        default:
